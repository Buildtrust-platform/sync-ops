  ...
  const milestones: Milestone[] = [
    {
      ...
      icon: "🚀",
      color: "blue",
      status: getDateStatus(project.projectStartDate),
    },
    {
      id: "deadline",
      ...
      icon: "🎯",
      color: "red",
      status: getDateStatus(project.deadline),
    },
    {
      id: "firstDraft",
      ...
      icon: "📝",
      color: "yellow",
      status: getDateStatus(project.firstDraftDate),
    },
    {
      id: "finalDelivery",
      label: "Final Deliverable Date",
      date: project.finalDeliverableDate,
      phase: "Distribution",
      icon: "📦",
      color: "green",
      status: getDateStatus(project.finalDeliverableDate),
    },
    {
      id: "shootStart",
      label: "Shoot Start Date",
      date: project.shootStartDate,
      phase: "Production",
      icon: "🎬",
      color: "purple",
      status: getDateStatus(project.shootStartDate),
    },
    {
      id: "shootEnd",
      label: "Shoot End Date",
      date: project.shootEndDate,
      phase: "Production",
      icon: "🏁",
      color: "purple",
      status: getDateStatus(project.shootEndDate),
    },
