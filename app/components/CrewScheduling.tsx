...
export default function CrewScheduling({
  ...
  useEffect(() => {
    ...
    const mockShootDays: ShootDay[] = [
      {
        ...
        date: "2024-03-01",
        dayNumber: 1,
        location: "Downtown Studio - Stage A",
        callTime: "06:00",
        wrapTime: "18:00",
        scenes: ["1", "2", "5"],
      },
      ...
      },
      {
        ...
        date: "2024-03-03",
        dayNumber: 3,
        location: "Industrial District - Exterior",
        callTime: "05:00",
        wrapTime: "17:00",
        scenes: ["6", "7", "8"],
        isHold: true,
    ...
    // Mock bookings
    const mockBookings: CrewBooking[] = [
      {
        id: "booking-1",
        projectId,
        crewMemberId: "crew-1",
