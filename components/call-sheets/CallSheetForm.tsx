    ...
    try {
      ...
      if (data) {
        setFormData({
          ...
          totalShootDays: data.totalShootDays || 1,
          shootDate: data.shootDate || '',
          episodeNumber: data.episodeNumber || '',
          generalCrewCall: data.generalCrewCall || '07:00',
          estimatedWrap: data.estimatedWrap || '18:00',
          timezone: data.timezone || Intl.DateTimeFormat().resolvedOptions().timeZone,
          primaryLocation: data.primaryLocation || '',
          primaryLocationAddress: data.primaryLocationAddress || '',
          ...
          firstADName: data.firstADName || '',
          firstADPhone: data.firstADPhone || '',
          productionManagerName: data.productionManagerName || '',
          productionManagerPhone: data.productionManagerPhone || '',
          productionOfficePhone: data.productionOfficePhone || '',
          mealTimes: data.mealTimes || '',
          cateringLocation: data.cateringLocation || '',
          transportationNotes: data.transportationNotes || '',
          safetyNotes: data.safetyNotes || '',
          specialInstructions: data.specialInstructions || '',
          nextDaySchedule: data.nextDaySchedule || '',
        });
      }
    } catch (error) {
    ...
    return (
      <div className="flex items-center justify-center p-12">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading call sheet data...</p>
        </div>
      </div>
    );
  }
