...
export default function CrewManagementForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Error', 'Failed to save crew member. Please try again.');
    }
  };
  ...
  const handleDelete = async (crewId: string) => {
    ...
    try {
      ...
      toast.error('Error', 'Failed to delete crew member. Please try again.');
    }
  };
  ...
  const moveCrew = async (crewId: string, direction: 'up' | 'down') => {
    ...
    try {
      ...
      toast.error('Error', 'Failed to reorder crew. Please try again.');
    }
  };
